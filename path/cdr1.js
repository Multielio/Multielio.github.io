...
class Menu extends Elements{
	constructor(){
		super();
	}
	update(){
		fill(255,0,0);
		rect(this.xtop,this.ytop,300,500);


		fill(255,255,255);
		rect(this.xtop+10,this.ytop+10,100,100);

		fill(0,255,255);
		rect(this.xtop+150,this.ytop+10,25,100);

		fill(0,255,255);
		rect(this.xtop+185,this.ytop+10,25,100);

		fill(0,0,255);
		rect(this.xtop+10,this.ytop+120,250,100);
		fill(255);
		textSize(14);
		text("Vitesse roue gauche",this.xtop+10,this.ytop+135);

		fill(0,0,255);
		rect(this.xtop+10,this.ytop+240,250,100);
		fill(255);
		textSize(14);
		text("Vitesse roue droite",this.xtop+10,this.ytop+260);
	}

}
class Sim extends Elements{
	constructor(){
		super();
	}
	update(){
		fill(0,255,0);
		rect(this.xtop,this.ytop,700,500);
		image(img, 0, 0);
...
class Scene {
	...
	constructor(terrainsizex){
		this.tsizex = terrainsizex;
		this.menu = new Menu();
		this.menu2 = new Menu();
		this.menu.xtop = 700;
		this.menu.ytop = 0;
		this.menu2.xtop = 1000;
		this.menu2.ytop = 0;
		this.sim = new Sim();
		this.sim.xtop = 0;
		this.sim.ytop = 0;
