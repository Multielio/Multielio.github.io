  ...
  calculate(){
    for(var i =0;i<this.path.length;i++){
      ...
      if(i==0 || i == this.path.length-1){
        ...
        var v = min(this.maxvel, this.k*r);
      }
      cpoint.z = newv;
    }
    for(var i =0;i<this.path.length;i++){
      ...
      if(i == this.path.length-1){
        ...
        newv = min(v,sqrt(pow(npoint.z,2)+2*this.a*dis));
      }
      cpoint.z = newv;
    }
...
function draw() {
  background(220);
  rect(x1o1-100*sin(0.5*u),y1o1,x2o1-x1o1,y2o1-y1o1);
  rect(x1o2,y1o2-100*sin(u),x2o2-x1o2,y2o2-y1o2);
  m = new Map(75,lv);
  m.cmatrix();
  m.addBigObstacleDiffc(x1o1-70*sin(0.5*u),y1o1,x2o1-70*sin(0.5*u),y2o1);
  m.addBigObstacleDiffc(x1o2,y1o2-100*sin(u),x2o2,y2o2-100*sin(u));
